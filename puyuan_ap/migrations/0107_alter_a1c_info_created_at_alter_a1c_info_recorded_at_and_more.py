...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('puyuan_ap', '0106_alter_a1c_info_created_at_alter_a1c_info_recorded_at_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='vip_info',
            name='updated_at',
            field=models.DateTimeField(default=datetime.datetime(2023, 10, 7, 23, 44, 27, 153261)),
        ),
    ]
