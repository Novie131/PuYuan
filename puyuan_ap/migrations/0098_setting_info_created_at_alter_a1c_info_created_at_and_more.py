...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('puyuan_ap', '0097_alter_a1c_info_created_at_alter_a1c_info_recorded_at_and_more'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='created_at',
            field=models.DateTimeField(default='2023-10-06 19:08'),
        ),
        ...
        migrations.AlterField(
            model_name='vip_info',
            name='updated_at',
            field=models.DateTimeField(default=datetime.datetime(2023, 10, 6, 19, 8, 50, 973931)),
        ),
    ]
